...
\relatore{Prof.\ Ugo Foscolo}% per la laurea e/o il dottorato
...
\tutoreaziendale{Dr.\ Giuseppe Ungaretti}
...
\sedutadilaurea{\textsc{April} 2022}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \TutorName{Tutor}
  \NomeTutoreAziendale{ACME Tutor}
  %\CycleName{cycle}
